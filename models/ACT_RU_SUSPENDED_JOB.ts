...
import {actRuSuspendedJobInstance, actRuSuspendedJobAttribute} from './db';

module.exports = function(sequelize: sequelize.Sequelize, DataTypes: DataTypes) {
  return sequelize.define<actRuSuspendedJobInstance, actRuSuspendedJobAttribute>('actRuSuspendedJob', {
    id: {
