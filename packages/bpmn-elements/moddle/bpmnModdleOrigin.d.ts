...
declare namespace BpmnModdleOrigin {
  ...
  interface BpmnModdleOriginConstructor {
    new(packages?: any, options?: Option): BpmnModdleOrigin;
  }
  ...
  interface BpmnModdleOrigin extends Moddle {
    /**
  ...
  type GeneralElement = ElementTypes[keyof ElementTypes]
}

export const BpmnModdleOrigin: BpmnModdleOrigin.BpmnModdleOriginConstructor
